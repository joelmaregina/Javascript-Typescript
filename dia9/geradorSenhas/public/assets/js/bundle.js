...
var chkMaiusculas = document.querySelector('.chk_maiusculas');
var chkMinusculas = document.querySelector('.chk_minusculas');
var chkNumeros = document.querySelector('.chk_numeros');
var chkSimbolos = document.querySelector('.chk_simbolos');
var gerarSenha = document.querySelector('.gerar_senha');
...
function gera() {
  var senha = (0,_geraSenha__WEBPACK_IMPORTED_MODULE_0__["default"])(qtdCaracteres.value, chkMaiusculas.checked, chkMinusculas.checked, chkNumeros.checked, chkSimbolos.checked);
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "\nh1, h2, h3, h4, p, div{\n    margin: 1rem 0;\n}\n\nbody{\n    background-color: rgb(233, 179, 255);\n    display: flex;\n    flex-direction: column;\n    align-items: center;\n}\n\n.container{\n    background-color: #FFF;\n    width: fit-content;\n    height: fit-content;\n    display: flex;\n    flex-direction: column;\n    align-items: center;\n    justify-content: center;\n    border-radius: 15px;\n    padding: 5px 20px;\n    padding-bottom: 15px;\n}\n\n.senha-gerada{\n    font-size: 1.5em;\n    font-weight: bold;\n    margin-bottom: 1em;\n    color:rgb(128, 0, 178);\n    letter-spacing: 1px;\n}\n", "",{"version":3,"sources":["webpack://./src/assets/css/style.css"],"names":[],"mappings":";AACA;IACI,cAAc;AAClB;;AAEA;IACI,oCAAoC;IACpC,aAAa;IACb,sBAAsB;IACtB,mBAAmB;AACvB;;AAEA;IACI,sBAAsB;IACtB,kBAAkB;IAClB,mBAAmB;IACnB,aAAa;IACb,sBAAsB;IACtB,mBAAmB;IACnB,uBAAuB;IACvB,mBAAmB;IACnB,iBAAiB;IACjB,oBAAoB;AACxB;;AAEA;IACI,gBAAgB;IAChB,iBAAiB;IACjB,kBAAkB;IAClB,sBAAsB;IACtB,mBAAmB;AACvB","sourcesContent":["\nh1, h2, h3, h4, p, div{\n    margin: 1rem 0;\n}\n\nbody{\n    background-color: rgb(233, 179, 255);\n    display: flex;\n    flex-direction: column;\n    align-items: center;\n}\n\n.container{\n    background-color: #FFF;\n    width: fit-content;\n    height: fit-content;\n    display: flex;\n    flex-direction: column;\n    align-items: center;\n    justify-content: center;\n    border-radius: 15px;\n    padding: 5px 20px;\n    padding-bottom: 15px;\n}\n\n.senha-gerada{\n    font-size: 1.5em;\n    font-weight: bold;\n    margin-bottom: 1em;\n    color:rgb(128, 0, 178);\n    letter-spacing: 1px;\n}\n"],"sourceRoot":""}]);
// Exports
